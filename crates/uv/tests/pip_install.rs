...
/// Install a package from an index that requires authentication, provided via `UV_AUTH_URLS`
#[test]
fn install_package_basic_auth_from_uv_auth_urls() {
    let context = TestContext::new("3.12");
    ...
    uv_snapshot!(context.pip_install()
        ...
        .arg("--strict")
        .env("UV_AUTH_URLS", "public:heron@pypi-proxy.fly.dev"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    uv_snapshot!(context.pip_install()
        ...
        .arg("--reinstall")
        .arg("--no-cache")
        .env("UV_AUTH_URLS", "https://public:heron@pypi-proxy.fly.dev"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    uv_snapshot!(context.pip_install()
        ...
        .arg("--reinstall")
        .arg("--no-cache")
        .env("UV_AUTH_URLS", "https://public:heron@pypi-proxy.fly.dev/basic-auth"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    uv_snapshot!(context.pip_install()
        ...
        .arg("--reinstall")
        .arg("--no-cache")
        .env("UV_AUTH_URLS", "http://public:heron@pypi-proxy.fly.dev"), @r###"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    uv_snapshot!(context.pip_install()
        ...
        .arg("--reinstall")
        .arg("--no-cache")
        .env("UV_AUTH_URLS", "public:heron@pypi-proxy.fly.dev/basic-auth-different/simple"), @r###"
    success: false
    exit_code: 2
    ----- stdout -----
    ...
    uv_snapshot!(context.pip_install()
        ...
        .arg("--reinstall")
        .arg("--no-cache")
        .env("UV_AUTH_URLS", "public:heron@pypi-proxy-different.fly.dev"), @r###"
    success: false
    exit_code: 2
    ----- stdout -----
